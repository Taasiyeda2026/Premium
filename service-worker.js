const CACHE_NAME = 'premium-static-v34';
...
const CORE_ASSETS = [
  ...
  BASE + 'premium web/images/etgar.png',
  ...
  // Osem web
  BASE + 'osem web/index_osem.html',
  BASE + 'osem web/images/bgosem.png',
  BASE + 'osem web/images/aud.png',
  BASE + 'osem web/images/eye.png',
  BASE + 'osem web/images/idea.png',
  BASE + 'osem web/images/p1.png',
  BASE + 'osem web/images/p2.png',
  BASE + 'osem web/images/p3.png',
  BASE + 'osem web/images/physical.png',
  BASE + 'osem web/images/pin.png',
  BASE + 'osem web/images/vs.png',
  BASE + 'osem web/images/news1.png',
  BASE + 'osem web/images/news2.png',
  BASE + 'osem web/images/news3.png',
  BASE + 'osem web/images/news4.png',
  BASE + 'osem web/images/news5.png',
  BASE + 'osem web/images/news6.png',
  BASE + 'osem web/images/news7.png',
  BASE + 'osem web/images/news8.png',
  BASE + 'osem web/images/news9.png',
  BASE + 'osem web/images/news10.png',

  // Osem news
  BASE + 'osem web/news/allnews.html',
  BASE + 'osem web/news/newswork.html',
  BASE + 'osem web/news/newswork4-1.html',
  BASE + 'osem web/news/newswork4-2.html',
  BASE + 'osem web/news/shortnews.html',
  BASE + 'osem web/news/news1.html',
  BASE + 'osem web/news/news2.html',
  BASE + 'osem web/news/news3.html',
  BASE + 'osem web/news/news4.html',
  BASE + 'osem web/news/news5.html',
  BASE + 'osem web/news/news6.html',
  BASE + 'osem web/news/news7.html',
  BASE + 'osem web/news/news8.html',
  BASE + 'osem web/news/news9.html',
  BASE + 'osem web/news/news10.html',

  // Osem newsletters
  BASE + 'osem web/newsletter4.html',
  BASE + 'osem web/newsletter5.html',
  BASE + 'osem web/newsletter6.html',
  BASE + 'osem web/newsletter7.html',
  BASE + 'osem web/newsletter8.html',
  BASE + 'osem web/newsletter9.html',

  // Osem mentoring
  BASE + 'osem web/mentoring/workmentoring.html',

  // Osem creativeidea
  BASE + 'osem web/creativeidea/creative.html',
  BASE + 'osem web/creativeidea/need.html',

  // Osem workaud
  BASE + 'osem web/workaud-8.html',
